...
You can add new posts for each pokemon in your collection. For each post you select the pokemon from the Pokedex
the post is associated with and select a featured image.
